...
class _SellScreenState extends State<SellScreen> {
  ...
  String _selectedFilter = "All"; // "All", "Active", "Sold"
          ...
          children: [
            ...
            StreamBuilder<List<ProductModel>>(
              stream: currentUserId.isNotEmpty
                  ? _productService.getFarmerProducts(currentUserId)
                  : Stream.value([]),
              builder: (context, snapshot) {
                ...
                final active = products.where((p) => p.available).length;
                final sold = products.where((p) => !p.available).length;
            ...
            // ================= Add Product Banner (Emerald Gradient) =================
            Container(
            ...
            Row(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    children: ["All", "Active", "Sold"].map((filter) {
